...
export const SHAPE_BUILDERS: Record<string, () => ShapeFace[]> = {
  ...
  valk: () => {
    ...
    return [
      ...
      // 조종석 창(요청) — 윗능선 앞에서 코로 미끄러지는 어두운 캐노피 + 유리 반짝임.
      capFace(polyPath3([[-0.55, 1.1, 7.85], [0.55, 1.1, 7.85], [0.4, 1.9, 6.7], [-0.4, 1.9, 6.7]]), 0.45),
      topFace(polyPath3([[-0.38, 1.2, 7.7], [0.1, 1.2, 7.7], [0, 1.6, 7.1], [-0.28, 1.6, 7.1]]), 0.3),
      // 지붕 미사일 튜브 다발.
