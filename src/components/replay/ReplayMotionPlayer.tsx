...
const SHAPE_FACES: Record<string, ShapeFace[]> = {
  ...
  /* 스포닝 풀(요청) — 동그란 젤리(반투명) 큰 것 하나 + 작은 것 둘을 힘줄이 감싼 꼴.
     반투명은 면의 불투명도로 낸다(currentColor 0.5대) — 뒤 지형이 살짝 비친다. */
  pool: [
    sideFace("M2 13.4a6 1.4 0 1 0 12 0a6 1.4 0 1 0-12 0Z", 0.22),
    ["M2.5 9a4 3.1 0 1 0 8 0a4 3.1 0 1 0-8 0Z", 0.55],
    ["M9.9 7.3a2.2 1.7 0 1 0 4.4 0a2.2 1.7 0 1 0-4.4 0Z", 0.55],
    ["M9.2 11.9a1.9 1.5 0 1 0 3.8 0a1.9 1.5 0 1 0-3.8 0Z", 0.55],
    // 윗머리 반짝임 — 젤리의 물기.
    ["M4.3 7.4a1.7 0.9 0 1 0 3.4 0a1.7 0.9 0 1 0-3.4 0Z", 0.3, "#fff"],
    ["M11 6.5a1 0.5 0 1 0 2 0a1 0.5 0 1 0-2 0Z", 0.3, "#fff"],
    // 힘줄 — 젤리를 감싸는 가는 띠들(불투명, 위에 얹힘).
    ["M2.7 8 Q6.5 5.4 10.3 8 Q6.5 6.6 2.7 8 Z", 1],
    ["M3 10.6 Q7 12.8 10.2 10.4 Q6.8 11.8 3 10.6 Z", 1],
    ["M10 6.2 Q12.2 4.9 14.2 6.6 Q12.2 5.9 10 6.2 Z", 1],
    ["M9.4 11.2 Q11.2 10.2 12.9 11.4 Q11.1 10.9 9.4 11.2 Z", 1],
    ["M9.7 8.6 Q10.6 8.9 11 9.9 Q10.2 9.3 9.5 9.3 Z", 1],
    // 오른쪽 그늘 — 표준 음영 규칙.
    sideFace("M8.9 6.4 Q10.5 7.6 10.5 9 Q10.5 10.6 8.9 11.7 Q10 9.9 8.9 6.4 Z", 0.2),
  ] as ShapeFace[],
