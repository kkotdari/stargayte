  ...
  devourer: () => [
    ...
    ...((): ShapeFace[] => {
      ...
      const segs9: [number, number, number, number][] = [ // [y, 반지름, 높이, 바닥 z]
        // 끝 마디(가장 아래)는 특히 많이 앞으로(재지적) — 머리 밑까지 파고든다.
        [1.6, 0.85, 0.85, 0.5], [-0.6, 1.15, 1.1, 1.5], [-2.1, 1.5, 1.35, 2.95],
      ];
    ...
    // 등판 이음선.
    sideFace(polyPath3([[0, 1.6, 1.3], [0, -1, 2.8], [0, -0.4, 6.3], [0.16, -0.4, 6.3], [0.16, -1, 2.8], [0.16, 1.6, 1.3]]), 0.16),
