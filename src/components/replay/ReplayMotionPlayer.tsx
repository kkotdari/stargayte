...
/** 자원이 건물보다 앞서는 몫 — 2.625타일이다(1.5타일의 앞섬 + 옛 그림상자 몫 1.125).
 *  자원은 배경이라 가려지면 지도가 안 읽히고, 건물 모형은 제 발자국보다 훨씬 크게
 *  그려져 한 줄 뒤에 서 있어도 앞 자원을 덮는다. 정말 2.6타일 넘게 앞에 선 건물만
 *  자원을 가린다.
...
export default function ReplayMotionPlayer({
  ...
  const [quality, setQuality] = useState(3);   // 기본 고(요청)
