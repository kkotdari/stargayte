...
const SHAPE_FACES: Record<string, [string, number, string?][]> = {
  ...
  /* 터렛 — 좁은 받침 위에 그보다 큰 대가리(지적: 대가리가 더 크다) — 대가리는 미사일
     포드 두 개를 나란히 붙인 것이다. */
  turret: [
    ["M5.4 14 H10.6 V10.4 H5.4 Z", 1],
    ["M5.4 14 H10.6 V10.4 H5.4 Z", 0.3, "#000"],
    ["M3.2 10.8 V5.4 Q3.2 4 5.2 4 Q7.2 4 7.2 5.4 V10.8 Z", 1],
    ["M8.8 10.8 V5.4 Q8.8 4 10.8 4 Q12.8 4 12.8 5.4 V10.8 Z", 1],
    ["M3.9 5.2a1.3 0.6 0 1 0 2.6 0a1.3 0.6 0 1 0-2.6 0Z M9.5 5.2a1.3 0.6 0 1 0 2.6 0a1.3 0.6 0 1 0-2.6 0Z", 0.3, "#fff"],
  ],
