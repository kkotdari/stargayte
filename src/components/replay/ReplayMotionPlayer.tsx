...
const ZERG_MOUND =
  ...
  /* 뒤 세 다리의 재투영(지적) — 뒤-왼은 몸통에 가려 안 그리고, 뒤-오른(+100°)은 오른쪽
     ...
     어깨 너머 작은 등만. */
  + " M12.2 10.2 Q14.2 9.6 15.7 9.9 Q16.2 10.4 15.8 11 Q14.5 11.9 12.5 11.7 Q12 11 12.2 10.2 Z"
  + " M12.9 9.7 Q13.9 8.9 14.6 9.2 Q15 9.7 14.4 10.2 Q13.6 10.6 12.9 10.3 Z";
