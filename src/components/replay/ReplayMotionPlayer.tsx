...
const ZERG_MOUND =
  ...
  /* 반원통 다리(지적: 아직도 바닥이 둥글어 보임) — 바닥 변은 완전한 수평 직선(L)이고
     ...
     갈퀴는 좁고 가파른 마루로만 솟는다. */
  /* 앞줄 세 다리(지적: 너무 짧다 — 조금 길게) — 바닥 수평 직선 + 작은 모서리, 사이
     갈퀴는 좁은 마루. 가운데 다리가 가장 낮게(가장 가깝게) 내려온다. */
  + " M11.5 10"
  + " Q13.6 10.4 14 12 Q14.2 14.4 13 14.4 L10.8 14.4 Q10.2 14.4 10.1 13.3"
  + " Q9.9 12.9 9.6 13.2"
  + " Q9.5 15 8.7 15 L7.3 15 Q6.7 15 6.6 13.3"
  + " Q6.4 12.9 6.1 13.2"
  + " Q6 14.4 5.2 14.4 L3 14.4 Q1.9 14.4 2 12.2"
  + " Q2.2 10.5 4.5 10"
  + " Q8 11.4 11.5 10 Z"
  /* 뒷줄 두 다리(지적: 부자연스러움) — 몸통 옆구리에서 위-밖으로 뻗는 둥근 갈래.
     뒤로 뻗는 것이라 끝이 밑동보다 살짝 높다. */
...
const ZERG_CAP_RF = "M10.9 14.35 A1.05 0.95 0 0 1 12.8 14.1 Z";
const ZERG_CAP_CF = "M6.9 14.95 A1.15 1.1 0 0 1 9.1 14.95 Z";
const ZERG_CAP_LF = "M3.2 14.1 A1.05 0.95 0 0 1 5.1 14.35 Z";
