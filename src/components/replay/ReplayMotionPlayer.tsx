...
export const SHAPE_BUILDERS: Record<string, () => ShapeFace[]> = {
  ...
  sunken: () => [
    // 갈퀴 바닥 + 더 납작한 둔덕(지적).
    ...creepSplat(6.6),
    ...domeFaces3(0, 0, 5.4, 1),
    ...hornFaces(-4, -1.6, 0.7, -5.2, -2.4, 2.8, 0.9),
    ...hornFaces(-2, -3, 0.7, -2.6, -4.2, 2.6, 0.9),
    ...hornFaces(3.4, -2.2, 0.7, 4.6, -3, 2.6, 0.9),
    ...hornFaces(-1.2, 1.2, 0.9, -2.2, 0.4, 3.8, 1.2),
    // 큰 낫 — 두 마디로 굽어 앞바닥을 향한다.
    ...hornFaces(1, -0.6, 1, 3.6, 1.4, 5.6, 1.9),
