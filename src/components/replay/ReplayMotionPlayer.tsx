  ...
  devourer: () => [
    ...
    ...((): ShapeFace[] => {
      ...
      const segs9: [number, number, number, number][] = [ // [y, 반지름, 높이, 바닥 z]
        /* 세 마디 모두 앞으로(재지적: 뒤로 너무 튀어나옴) — 간격은 서로 겹치도록
           좁게 유지해 마디가 끊기지 않는다. */
        [2.75, 0.85, 0.85, 1.35], [1.5, 1.15, 1.1, 2.1], [0.05, 1.5, 1.35, 2.95],
      ];
    ...
    // 등판 이음선.
    sideFace(polyPath3([[0, 2.75, 2.1], [0, 1.35, 3.3], [0, -0.4, 6.3], [0.16, -0.4, 6.3], [0.16, 1.35, 3.3], [0.16, 2.75, 2.1]]), 0.16),
