...
const SHAPE_FACES: Record<string, ShapeFace[]> = {
  ...
  hive: [
    [`${ZERG_MOUND}`
      + " M2.1 10 Q1 4.8 3.6 1.7 Q5.2 0.3 6.6 1.1 Q5.4 1.5 4.6 3.1 Q3.6 6.2 4.3 9.8 Z"
      + " M8.9 9.8 Q9 3.4 10.4 0.6 Q11.8 3.9 11.1 9.8 Z"
      + " M14.5 10.6 Q15.8 5 13.3 1.9 Q11.9 0.6 10.8 1.3 Q11.9 1.5 12.5 3.1 Q13.5 5.8 12.6 10.2 Z"
