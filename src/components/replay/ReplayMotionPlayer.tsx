...
const ZERG_MOUND =
  ...
  /* 반원통 다리(지적: 아직도 바닥이 둥글어 보임) — 바닥 변은 완전한 수평 직선(L)이고
     ...
     갈퀴는 좁고 가파른 마루로만 솟는다. */
  /* 시점 보정(지적: 정면이 아니라 살짝 정면-오른쪽 위에서 내려다본 모양) — 방사형 다리를
     시계 20도쯤 돌려 앉힌다: 카메라 쪽(앞-오른쪽) 다리는 짧게 눌려 단면이 크고, 왼쪽으로
     갈수록 옆모습이라 길게 뻗으며 단면이 작아진다. */
  + " M11.4 10.3"
  + " Q12.8 11.6 13.2 13.5 Q13.3 14.1 12.7 14.2 L11.7 14.4 Q11 14.5 10.9 13.8"
  + " Q10.5 12.6 9.9 12"
  + " Q9.4 11.6 9 11.9"
  + " Q8.2 12.6 7.2 13.6 Q6.4 14.4 5.7 14.9 Q5.2 15.3 4.7 14.9 L4.2 14.5 Q3.8 14 4.3 13.5"
  + " Q5 12.7 5.9 11.8"
  + " Q5.5 11.4 5.1 11.6"
  + " Q3.6 11.9 2.2 12.6 Q1.4 13 1 12.6 L0.7 12.1 Q0.5 11.6 1.2 11.3"
  + " Q2.8 10.7 4.3 10.4"
  + " Q8 11.3 11.4 10.3 Z"
  /* 뒷줄 두 다리 — 왼뒤는 옆이 더 보여 길게, 오른뒤는 몸통에 가려 짧은 토막. */
  + " M3 10.1 Q1.2 8.7 0.3 9.2 Q-0.2 9.9 0.6 10.5 Q1.9 11.2 3.1 10.9 Z"
  + " M12.6 10 Q13.8 8.8 14.7 9.1 Q15.2 9.7 14.5 10.3 Q13.6 10.9 12.7 10.6 Z";
...
const ZERG_CAP_RF = "M10.95 13.85 A1.05 1 0 0 1 12.75 14.1 Z";
const ZERG_CAP_CF = "M4.35 14.4 A0.85 0.8 0 0 1 5.65 14.95 Z";
const ZERG_CAP_LF = "M0.85 12 A0.65 0.6 0 0 1 1.15 13.05 Z";
...
const SHAPE_FACES: Record<string, ShapeFace[]> = {
  ...
  lair: [
    [`${ZERG_MOUND}`
      + " M1.2 11 Q0.2 5.7 3 2.4 Q4.6 0.8 6 1.6 Q4.8 1.8 4 3.4 Q2.8 6 3.4 10.6 Z"
      + " M13.6 10.4 Q14.8 5.4 12.4 2.6 Q11 1.2 9.8 1.9 Q10.9 2.1 11.6 3.5 Q12.5 5.9 11.6 10 Z", 1],
    sideFace(ZERG_SHADE, 0.22),
    capFace(ZERG_CAPS_ALL),
    sideFace(ZERG_COLLAR, 0.35),
    topFace("M4 1.2 L5.4 1.6 L3.8 2.6 Z M11.5 1.6 L10.2 1.9 L11.6 3 Z", 0.5),
    topFace(ZERG_TOP),
  ],
  ...
  hive: [
    [`${ZERG_MOUND}`
      + " M1 11 Q-0.2 5 2.6 1.6 Q4.2 0.2 5.6 1 Q4.4 1.4 3.6 3 Q2.4 6.2 3.2 10.6 Z"
      + " M7.4 10.2 Q7.2 3.8 8.9 0.5 Q10.5 3.8 10.1 10.2 Z"
      + " M13.4 10.4 Q14.6 4.8 12.2 1.9 Q10.8 0.6 9.7 1.3 Q10.8 1.5 11.4 3.1 Q12.3 5.8 11.4 10 Z"
      + " M2.6 14.6 Q1.4 15.4 0.8 14.6 Q1.6 14.4 2 13.8 Z"
      + " M13.4 14.6 Q14.6 15.4 15.2 14.6 Q14.4 14.4 14 13.8 Z", 1],
    sideFace(ZERG_SHADE, 0.22),
    capFace(ZERG_CAPS_ALL),
    sideFace(ZERG_COLLAR, 0.35),
    topFace("M4.2 0.4 L5.6 1 L4 2 Z M11.3 1 L10 1.3 L11.4 2.4 Z M8.2 1.2 Q8.9 0.1 9.6 1.2 L8.9 2.4 Z", 0.5),
    topFace(ZERG_TOP),
  ],
