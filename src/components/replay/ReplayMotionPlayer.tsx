...
const ZERG_MOUND =
  ...
  + " Q10.6 12.5 10 12.1"
  + " Q9.5 11.8 9.2 12.2"
  + " Q8.9 13.2 8.3 14.2 Q8 14.9 7.3 14.9 L6.3 14.7 Q5.7 14.5 5.9 13.8"
  + " Q6.2 12.8 6.5 12.1"
  + " Q6.1 11.7 5.7 12"
  + " Q4.3 12.3 2.6 12.4 Q1.5 12.4 1.2 12 L1 11.5 Q0.9 11 1.6 10.9"
  + " Q3 10.7 4.4 10.4"
  + " Q8 11.4 11.2 10.4 Z"
  + " M12.6 10.1 Q14.6 9.9 15.6 10.4 Q16.1 10.9 15.5 11.3 Q14.3 11.9 12.8 11.5 Z"
  + " M2.7 10.2 Q1 9 0.2 9.5 Q0 10.2 0.7 10.8 Q1.9 11.4 2.9 11 Z"
  + " M12.9 9.9 Q13.9 9.1 14.6 9.4 Q15 9.9 14.4 10.4 Q13.6 10.8 12.9 10.5 Z";
...
const ZERG_CAP_CF = "M6.15 14.6 A1.02 0.97 0 0 1 8.1 14.75 Z";
...
const SHAPE_FACES: Record<string, ShapeFace[]> = {
  ...
  lair: [
    [`${ZERG_MOUND}`
      + " M0.9 10.8 Q0 5.6 2.8 2.5 Q4.4 1 5.8 1.8 Q4.6 2 3.8 3.6 Q2.6 6.2 3.2 10.4 Z"
      + " M13.9 10.2 Q15 5.4 12.7 2.7 Q11.3 1.4 10.1 2.1 Q11.2 2.3 11.9 3.7 Q12.7 6 11.9 9.9 Z", 1],
    sideFace(ZERG_SHADE, 0.22),
    capFace(ZERG_CAPS_ALL),
    sideFace(ZERG_COLLAR, 0.35),
    topFace("M4.4 1.4 L5.8 1.8 L4.2 2.8 Z M11.8 1.8 L10.5 2.1 L11.9 3.2 Z", 0.5),
    topFace(ZERG_TOP),
  ],
  ...
  hive: [
    [`${ZERG_MOUND}`
      + " M0.7 10.8 Q-0.3 4.8 2.4 1.7 Q4 0.3 5.4 1.1 Q4.2 1.5 3.4 3.1 Q2.2 6.2 3 10.4 Z"
      + " M8 10 Q7.9 3.6 9.5 0.6 Q11 3.9 10.5 10 Z"
      + " M13.7 10.2 Q14.9 4.6 12.5 1.9 Q11.1 0.6 10 1.3 Q11.1 1.5 11.7 3.1 Q12.6 5.8 11.7 9.9 Z"
      + " M4.9 15 Q3.7 15.7 3.2 15 Q4 14.8 4.3 14.2 Z"
      + " M10.5 14.4 Q11.7 15.1 12.3 14.4 Q11.4 14.2 11.1 13.7 Z", 1],
    sideFace(ZERG_SHADE, 0.22),
    capFace(ZERG_CAPS_ALL),
    sideFace(ZERG_COLLAR, 0.35),
    topFace("M4 0.7 L5.4 1.1 L3.8 2.1 Z M11.1 1 L10 1.3 L11.2 2.4 Z M9 1 Q9.5 0.1 10 1.1 L9.5 2.1 Z", 0.5),
    topFace(ZERG_TOP),
  ],
