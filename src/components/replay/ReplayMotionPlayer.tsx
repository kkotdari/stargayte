  ...
  devourer: () => [
    ...
    ...((): ShapeFace[] => {
      ...
      const segs9: [number, number, number, number][] = [ // [y, 반지름, 높이, 바닥 z]
        [2.4, 0.72, 0.72, 0.95], [0.9, 0.98, 0.92, 1.6],
        [0.25, 1.25, 1.15, 2.35], [0, 1.5, 1.35, 3.05],
      ];
    ...
    // 등판 이음선.
    sideFace(polyPath3([[0, 2.4, 1.65], [0, 0.6, 2.9], [0, -0.4, 6.3], [0.16, -0.4, 6.3], [0.16, 0.6, 2.9], [0.16, 2.4, 1.65]]), 0.16),
