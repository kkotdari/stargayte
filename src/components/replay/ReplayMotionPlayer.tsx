...
const SHAPE_FACES: Record<string, ShapeFace[]> = {
  ...
  hive: [
    [`${ZERG_MOUND}`
      + " M4.2 10.6 Q2.6 5 4.6 1.4 Q5.9 0.2 7.2 0.9 Q6.2 1.4 5.7 3 Q5.1 6.6 5.9 10.2 Z"
      + " M8.8 10.2 Q9 4.2 10.1 0.8 Q11.3 4.4 10.7 10 Z"
      + " M14.7 10.9 Q16 6 14.8 1.6 Q13.6 6.4 13.7 10.5 Z"
    ...
    sideFace(ZERG_COLLAR, 0.35),
    topFace("M6 0.4 L7.2 0.9 L5.7 1.8 Z M9.8 1 L10.4 1.9 L9.4 2 Z M14.5 1.7 L15.1 2.7 L13.9 2.6 Z", 0.5),
    topFace(ZERG_TOP),
  ],
