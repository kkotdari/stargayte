...
const ZERG_MOUND =
  ...
  /* 반원통 다리(지적: 아직도 바닥이 둥글어 보임) — 바닥 변은 완전한 수평 직선(L)이고
     ...
     갈퀴는 좁고 가파른 마루로만 솟는다. */
  + " M11.5 10"
  + " Q14.9 10.7 15.2 12.5 Q15.2 13.2 14.6 13.2 L13.1 13.2 Q12.7 13.2 12.6 12.8"
  + " Q12.5 12.5 12.3 12.8"
  + " Q12.2 14 11.6 14 L10.2 14 Q9.7 14 9.6 13.3"
  + " Q9.4 12.9 9.1 13.2"
  + " Q9 14.3 8.4 14.3 L7.4 14.3 Q6.9 14.3 6.8 13.4"
  + " Q6.6 13 6.3 13.3"
  + " Q6.2 14 5.6 14 L4.2 14 Q3.7 14 3.6 12.9"
  + " Q3.4 12.5 3.2 12.8"
  + " Q3.1 13.2 2.5 13.2 L1 13.2 Q0.3 13.2 0.3 12.5 Q0.6 10.7 4.5 10"
  + " Q8 11.4 11.5 10 Z";
...
const SHAPE_FACES: Record<string, ShapeFace[]> = {
  ...
  lair: [
    [`${ZERG_MOUND}`
      + " M2.4 12.6 Q1.6 8.6 2.7 5.2 Q3.5 8.8 3.8 12.7 Z"
      + " M6 13.7 Q5.7 9.4 6.7 6.2 Q7.5 9.8 7.6 13.9 Z"
      + " M13 13.2 Q13.9 7.6 12.9 3.6 Q12 8 11.6 13.3 Z", 1],
  ...
  hive: [
    [`${ZERG_MOUND}`
      + " M2.2 12.6 Q1.1 6.4 2.6 1.6 Q3.7 7 4 12.7 Z"
      + " M5.9 13.7 Q5.4 7.6 6.6 3 Q7.7 8.4 7.7 13.9 Z"
      + " M13.1 13.2 Q14.4 6 13.1 0.7 Q11.8 7 11.5 13.3 Z"
      + " M3 7.6 L5.6 8.8 L3.5 9.8 Z M12.8 6.8 L10.2 8.2 L12.4 9.2 Z", 1],
    sideFace(ZERG_SHADE, 0.22),
    topFace(ZERG_TOP),
  ],
