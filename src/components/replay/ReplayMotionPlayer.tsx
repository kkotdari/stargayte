...
export const SHAPE_BUILDERS: Record<string, () => ShapeFace[]> = {
  ...
  tanksiege: () => {
    ...
    return [
      /* 고정 발(정정: 양옆과 뒤, 직각으로 구부러진 발) — 차체 옆구리에서 수평으로
         뻗은 팔이 끝에서 직각으로 꺾여 땅으로 내려서고, 바닥엔 넓은 발판을 문다.
         전엔 사방 대각 다리 넷이었다. 윗부분(차체·포탑·포신)은 그대로. */
      // 왼발.
      ...boxFaces3(-2.55, 0, 1.9, 0.9, 0.5, 1.5),
      ...boxFaces3(-3.6, 0, 0.8, 0.8, 1.7),
      ...boxFaces3(-3.6, 0, 1.4, 1.3, 0.35),
      // 오른발.
      ...boxFaces3(2.55, 0, 1.9, 0.9, 0.5, 1.5),
      ...boxFaces3(3.6, 0, 0.8, 0.8, 1.7),
      ...boxFaces3(3.6, 0, 1.4, 1.3, 0.35),
      // 뒷발.
      ...boxFaces3(0, -2.55, 0.9, 1.9, 0.5, 1.5),
      ...boxFaces3(0, -3.6, 0.8, 0.8, 1.7),
      ...boxFaces3(0, -3.6, 1.3, 1.4, 0.35),
      // 옆이 아니라 앞뒤로 긴 차체(정정).
  ...
  /* 아비터(원복, 요청) — 작은 몸체 양옆에 긴 타원형 날개가 방패처럼 뒤를 향해 길게
