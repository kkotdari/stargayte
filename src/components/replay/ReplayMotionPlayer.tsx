...
export const SHAPE_BUILDERS: Record<string, () => ShapeFace[]> = {
  ...
  corsair: () => {
    ...
    return [
      bodyFace(groundEllipse(cx, cy, 2.6, 2.1)),
      sideFace(`M${cx + 0.8} ${cy - 1.8} Q${cx + 2.6} ${cy - 1} ${cx + 2.3} ${cy + 1.2} Q${cx + 2.4} ${cy - 0.6} ${cx + 0.8} ${cy - 1.8} Z`, 0.18),
      topFace(groundEllipse(cx - 0.9, cy - 0.9, 1.1, 0.8), 0.2),
      // 앞으로 감아 도는 옆 팔.
