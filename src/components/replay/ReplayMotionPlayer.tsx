...
export const SHAPE_BUILDERS: Record<string, () => ShapeFace[]> = {
  ...
  queen: () => {
    ...
    return [
      // 아래 굵은 촉수 셋 + 그 사이 물갈퀴 막.
      ...hornFaces(-1.2, 0.6, 5.2, -1.7, 1.7, 3.1, 0.75),
      ...hornFaces(0, 0.4, 5.1, 0, 1.5, 2.9, 0.75),
      ...hornFaces(1.2, 0.6, 5.2, 1.7, 1.7, 3.1, 0.75),
      bodyFace(polyPath3([[-1.55, 1.5, 3.5], [-0.7, 1.2, 4.4], [0, 1.35, 3.3], [-0.9, 1.6, 3.1]])),
      sideFace(polyPath3([[-1.55, 1.5, 3.5], [-0.7, 1.2, 4.4], [0, 1.35, 3.3], [-0.9, 1.6, 3.1]]), 0.18),
      bodyFace(polyPath3([[1.55, 1.5, 3.5], [0.7, 1.2, 4.4], [0, 1.35, 3.3], [0.9, 1.6, 3.1]])),
      sideFace(polyPath3([[1.55, 1.5, 3.5], [0.7, 1.2, 4.4], [0, 1.35, 3.3], [0.9, 1.6, 3.1]]), 0.14),
      // 뒤 알주머니 — 점무늬.
