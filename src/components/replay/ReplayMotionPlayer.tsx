...
const SHAPE_FACES: Record<string, ShapeFace[]> = {
  ...
  gate: (() => {
    ...
    return [
      ...
      // 꼭대기는 살짝 뭉뚝하게(요청) — 뾰족 삼각 대신 좁은 평평 윗면.
      ["M7.3 4.9 L8.7 4.9 L11 11.8 L5 11.8 Z", 1],
      ["M8 4.9 L8.7 4.9 L11 11.8 L8 11.8 Z", 0.22, "#000"],
      ["M7.3 4.9 L8.7 4.9 L8.9 5.5 L7.1 5.5 Z", 0.25, "#fff"],
