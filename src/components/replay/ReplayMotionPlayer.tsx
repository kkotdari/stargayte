...
// (이동·재지적) 앞 톱니 원판 — 왼쪽 반원판의 이빨로 옮겼다.
  ...
  guardian: () => [
    /* 가디언(재지적) — 머리는 짙은 갈색이고 앞(+y)에 있으며, 몸통은 그 머리 뒤에서
       시작해 앞·아래로 굽어 내려온다. 뒤 마디부터 그려 앞 머리가 위에 온다. */
    // 몸통 — 뒤에서 시작해 앞으로 굽는 마디들(뒤가 높고 앞이 낮다).
    ...domeFaces3(0, -2.6, 1.35, 1.1, 6),
    ...domeFaces3(0, -1.5, 1.75, 1.3, 5.8),
    ...domeFaces3(0, -0.3, 2, 1.35, 5.5),
    // 게딱지 양옆 회백색(요청).
    ...paintBase(domeFaces3(-1.35, -0.9, 1.6, 1, 5.6), "#d3d7db"),
    ...paintBase(domeFaces3(1.35, -0.9, 1.6, 1, 5.6), "#d3d7db"),
    // 머리 — 짙은 갈색(요청), 몸통 앞끝에 붙어 아래로 숙는다.
    ...paintBase(domeFaces3(0, 1.1, 1.5, 1.15, 5), "#6b4732"),
    ...paintBase(domeFaces3(0, 2.1, 1.05, 0.85, 4.6), "#6b4732"),
    // 앞 양 집게 — 두 마디로 안쪽으로 굽는다. 짙은 갈색.
    ...paintBase(hornFaces(1.6, 1.2, 5.2, 2.7, 2.5, 4.9, 0.7), "#6b4732"),
    ...paintBase(hornFaces(2.7, 2.5, 4.9, 1.9, 3.5, 4.7, 0.5), "#6b4732"),
    ...paintBase(hornFaces(-1.6, 1.2, 5.2, -2.7, 2.5, 4.9, 0.7), "#6b4732"),
    ...paintBase(hornFaces(-2.7, 2.5, 4.9, -1.9, 3.5, 4.7, 0.5), "#6b4732"),
    // 옆 잔다리 — 짙은 갈색(요청).
    ...paintBase(hornFaces(2.2, -0.8, 5.6, 3.4, -1.4, 4.9, 0.45), "#6b4732"),
    ...paintBase(hornFaces(-2.2, -0.8, 5.6, -3.4, -1.4, 4.9, 0.45), "#6b4732"),
    ...paintBase(hornFaces(2, -1.8, 5.7, 3, -2.6, 5, 0.45), "#6b4732"),
    ...paintBase(hornFaces(-2, -1.8, 5.7, -3, -2.6, 5, 0.45), "#6b4732"),
  ],
