...
const SHAPE_FACES: Record<string, [string, number, string?][]> = {
  ...
  /* 서플라이 — 경사를 급하게, 거의 직육면체(지적) + 앞면에 동그라미 둘 가로 배치(요청:
     보급고 해치 둘). */
  trapezoid: [
    ["M3 5 13 5 14.2 12.6 1.8 12.6Z", 1],
    ["M3 5 L13 5 L14 6.2 L2 6.2 Z", 0.3, "#fff"],
    ["M4.3 9.6a1.5 1.3 0 1 0 3 0a1.5 1.3 0 1 0-3 0Z M8.7 9.6a1.5 1.3 0 1 0 3 0a1.5 1.3 0 1 0-3 0Z", 0.3, "#000"],
  ],
  gas: [
