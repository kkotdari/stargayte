...
// (이동·재지적) 앞 톱니 원판 — 왼쪽 반원판의 이빨로 옮겼다.
  ...
  carrier: () => {
    ...
    return [
      ...
      // 옆 두 잎의 개인색 장식은 아랫면으로(재지적).
      ...paintBase(lens(-1.3, -1, 5.1, 1.05, 3.9, "L"), "#d4af37"),
      [petal(-1.3, -1, 4.5, 0.55, 1.95), 0.4] as ShapeFace,
  ...
  dtemp: () => [
    ...
    // 다리(재요청) — 질럿과 같은 무릎 굽힌 캡슐 막대 두 마디씩. 몸통 빼고 금색(요청).
    ...paintBase([
      ...rodFaces(-0.55, -0.2, 3.5, -0.62, 0.5, 2.2, 0.7),
      ...rodFaces(-0.62, 0.5, 2.2, -0.6, -0.5, 1.1, 0.6),
      ...rodFaces(-0.6, -0.5, 1.1, -0.68, 0.8, 0.1, 0.5),
    ...
    ...paintBase([
      ...
      ...rodFaces(-1.5, 0.4, 4.6, -1.1, 1.2, 3.7, 0.45),
  ...
  htemp: () => {
    ...
    return [
      ...
      // 머리·뿔 금색(요청).
      ...paintBase(domeFaces3(0, -0.7, 1.05, 0.85, 6.8), "#d4af37"),
