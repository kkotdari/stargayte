...
const ZERG_MOUND =
  ...
  /* 반원통 다리(지적: 뒤집혀 있었다) — 바닥은 평평하고(L 직선) 위·어깨가 둥글다(Q).
     다리 사이 갈퀴는 위로 얕게 떠오른다. */
  + " M11.5 10"
  + " Q14.7 10.6 15.1 12.1 Q15.3 13.3 14.1 13.4 L12.9 13.4"
  + " Q12.6 12.9 12.3 12.8"
  + " Q12.1 14 11 14.1 L9.9 14.1"
  + " Q9.6 13.5 9.2 13.4"
  + " Q9 14.4 7.9 14.4 L6.8 14.4"
  + " Q6.5 13.5 6.2 13.4"
  + " Q6 14.1 4.9 14.1 L3.8 14"
  + " Q3.5 12.9 3.2 12.8"
  + " Q2.9 13.4 1.9 13.4 L0.7 13.3"
  + " Q0 13.2 0.3 12"
  + " Q0.8 10.7 4.5 10"
  + " Q8 11.4 11.5 10 Z";
