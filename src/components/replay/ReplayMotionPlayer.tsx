...
export const SHAPE_BUILDERS: Record<string, () => ShapeFace[]> = {
  ...
  bc: () => [
    // 추진기 — 꽁무니에 붙은 짧은 통 셋(삼각).
    ...tubeFaces(0, -3.7, 0, -2.4, 0.5, 6.4),
    ...tubeFaces(-0.95, -3.6, -0.95, -2.3, 0.5, 5.3),
    ...tubeFaces(0.95, -3.6, 0.95, -2.3, 0.5, 5.3),
    // 날개 — 옆으로 뻗는 납작 슬래브.
    ...boxFaces3(-3.3, -1, 2.4, 1.6, 0.5, 5.8),
    ...boxFaces3(3.3, -1, 2.4, 1.6, 0.5, 5.8),
    // 날개 위 미사일 — 앞으로 긴 상자 + 탄두.
    ...boxFaces3(-3.9, -0.4, 0.85, 2.8, 0.8, 6.3),
    ...hornFaces(-3.9, 1, 6.7, -3.9, 2.3, 6.6, 0.45),
    ...boxFaces3(3.9, -0.4, 0.85, 2.8, 0.8, 6.3),
    ...hornFaces(3.9, 1, 6.7, 3.9, 2.3, 6.6, 0.45),
