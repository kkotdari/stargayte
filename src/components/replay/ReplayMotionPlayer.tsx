...
export const SHAPE_BUILDERS: Record<string, () => ShapeFace[]> = {
  ...
  /* 퀸(정정 둘) — 위로 솟아 굽는 더듬이 한 쌍과 다리 사이 물갈퀴가 포인트.
     앞 큰 집게·뒤 점박이 알주머니는 유지. */
  queen: () => {
    ...
    return [
      // 다리는 여섯 방향으로(정정) — 사방으로 뻗는 굵은 촉수 여섯 + 앞쪽 사이 물갈퀴 막.
      ...hornFaces(-0.9, -1, 5.1, -1.5, -2.2, 3, 0.7),
      ...hornFaces(0.9, -1, 5.1, 1.5, -2.2, 3, 0.7),
      ...hornFaces(-1.3, 0, 5.2, -2.2, 0.2, 3.1, 0.75),
      ...hornFaces(1.3, 0, 5.2, 2.2, 0.2, 3.1, 0.75),
      ...hornFaces(-0.9, 0.8, 5.2, -1.4, 1.8, 3, 0.75),
      ...hornFaces(0.9, 0.8, 5.2, 1.4, 1.8, 3, 0.75),
      bodyFace(polyPath3([[-1.35, 1.6, 3.5], [-0.6, 1.1, 4.5], [0, 1.5, 3.3], [-0.8, 1.8, 3.1]])),
      sideFace(polyPath3([[-1.35, 1.6, 3.5], [-0.6, 1.1, 4.5], [0, 1.5, 3.3], [-0.8, 1.8, 3.1]]), 0.18),
      bodyFace(polyPath3([[1.35, 1.6, 3.5], [0.6, 1.1, 4.5], [0, 1.5, 3.3], [0.8, 1.8, 3.1]])),
      sideFace(polyPath3([[1.35, 1.6, 3.5], [0.6, 1.1, 4.5], [0, 1.5, 3.3], [0.8, 1.8, 3.1]]), 0.14),
      // 뒤 알주머니 — 점무늬.
      ...domeFaces3(0, -1.1, 1.95, 1.75, 5.3),
      spot(-0.6, -1.5), spot(0.4, -1.9), spot(0.1, -0.9),
      // 앞 머리딱지.
      ...domeFaces3(0, 0.7, 1.2, 0.9, 5.5),
      // 더듬이 한 쌍 — 위로 솟았다가 안으로 굽는다.
      ...hornFaces(0.6, 0.9, 6.3, 1.3, 0.6, 8.7, 0.45),
      ...hornFaces(1.3, 0.6, 8.6, 0.7, 0.3, 9.6, 0.32),
      ...hornFaces(-0.6, 0.9, 6.3, -1.3, 0.6, 8.7, 0.45),
      ...hornFaces(-1.3, 0.6, 8.6, -0.7, 0.3, 9.6, 0.32),
      // 큰 집게 한 쌍.
      ...hornFaces(1.3, 1, 5.8, 2.6, 2.2, 5.6, 0.95),
      ...hornFaces(2.6, 2.2, 5.6, 1.9, 3.5, 5.2, 0.7),
      ...hornFaces(-1.3, 1, 5.8, -2.6, 2.2, 5.6, 0.95),
      ...hornFaces(-2.6, 2.2, 5.6, -1.9, 3.5, 5.2, 0.7),
    ];
  },
