...
const ZERG_MOUND =
  ...
  + " M2.9 10.3 Q0.9 9.2 0 9.9 Q-0.4 10.6 0.5 11 Q1.9 11.6 3 11.2 Z"
  + " M13.2 10.3 Q14.9 9.6 15.6 10.1 Q16 10.7 15.3 11 Q14.2 11.4 13.3 11 Z";
...
const SHAPE_FACES: Record<string, ShapeFace[]> = {
  ...
  lair: [
    [`${ZERG_MOUND}`
      ...
      + " M14.8 11 Q15.8 5.7 13 2.4 Q11.4 0.8 10 1.6 Q11.2 1.8 12 3.4 Q13.2 6 12.6 10.6 Z", 1],
    sideFace(ZERG_SHADE, 0.22),
    capFace(ZERG_CAPS_ALL),
    sideFace(ZERG_COLLAR, 0.35),
    topFace("M4 1.2 L5.4 1.6 L3.8 2.6 Z M12 1.2 L10.6 1.6 L12.2 2.6 Z", 0.5),
    topFace(ZERG_TOP),
  ],
  ...
  hive: [
    [`${ZERG_MOUND}`
      ...
      + " M6.6 10.2 Q6.2 3.8 8 0.5 Q9.8 3.8 9.4 10.2 Z"
      + " M15 11 Q16.2 5 13.4 1.6 Q11.8 0.2 10.4 1 Q11.6 1.4 12.4 3 Q13.6 6.2 12.8 10.6 Z"
      + " M2.6 14.6 Q1.4 15.4 0.8 14.6 Q1.6 14.4 2 13.8 Z"
      + " M13.4 14.6 Q14.6 15.4 15.2 14.6 Q14.4 14.4 14 13.8 Z", 1],
    sideFace(ZERG_SHADE, 0.22),
    capFace(ZERG_CAPS_ALL),
    sideFace(ZERG_COLLAR, 0.35),
    topFace("M4.2 0.4 L5.6 1 L4 2 Z M11.8 0.4 L10.4 1 L12 2 Z M7.3 1.3 Q8 0.1 8.7 1.3 L8 2.5 Z", 0.5),
    topFace(ZERG_TOP),
  ],
