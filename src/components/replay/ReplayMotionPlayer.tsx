  ...
  devourer: () => [
    ...
    ...((): ShapeFace[] => {
      ...
      const segs9: [number, number, number, number][] = [ // [y, 반지름, 높이, 바닥 z]
        [2.95, 0.72, 0.72, 1.15], [2.05, 0.98, 0.92, 1.75],
        [1.05, 1.25, 1.15, 2.4], [-0.1, 1.5, 1.35, 3.05],
      ];
    ...
    // 등판 이음선.
    sideFace(polyPath3([[0, 2.95, 1.85], [0, 1.4, 3.1], [0, -0.4, 6.3], [0.16, -0.4, 6.3], [0.16, 1.4, 3.1], [0.16, 2.95, 1.85]]), 0.16),
