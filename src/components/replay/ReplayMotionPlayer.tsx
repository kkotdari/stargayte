...
const ZERG_MOUND =
  ...
  /* 뿌리를 몸통 옆구리 안쪽까지 밀어 넣는다(지적: 뒤 다리가 떠 있는 혹처럼 보임) —
     옆구리 곡선 밖에서 시작하면 붙지 않은 조각이 된다. */
  + " M11.6 10.4 Q14.2 9.6 15.7 9.9 Q16.2 10.4 15.8 11 Q14.5 11.9 12.2 11.8 Q11.4 11.1 11.6 10.4 Z"
  + " M11.6 10 Q13.4 8.9 14.4 9.2 Q14.8 9.7 14.2 10.2 Q13.1 10.8 11.7 10.6 Z";
