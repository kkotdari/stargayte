...
// (이동·재지적) 앞 톱니 원판 — 왼쪽 반원판의 이빨로 옮겼다.
  ...
  zealot: () => [
    ...
    // 얼굴은 반구 대신 작은 뒤집힌 계란형(지적) — 위가 둥글고 턱이 길게 좁아진다.
    ...((): ShapeFace[] => {
      const [hx, hy] = project(0, 0.35, 6.9);
      return [
        bodyFace(`M${hx - 0.72} ${hy} A0.72 0.55 0 0 1 ${hx + 0.72} ${hy} A0.72 1 0 0 1 ${hx - 0.72} ${hy} Z`),
        topFace(`M${hx - 0.72} ${hy} A0.72 0.55 0 0 1 ${hx + 0.72} ${hy} A0.72 0.4 0 0 0 ${hx - 0.72} ${hy} Z`, 0.2),
      ];
    })(),
