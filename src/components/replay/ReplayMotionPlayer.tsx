...
export const SHAPE_BUILDERS: Record<string, () => ShapeFace[]> = {
  ...
  evo: () => {
    ...
    return [
      ...
      // 심장 같은 살덩이 두 엽 — 더 크고 구형으로(지적), 크기 차이는 유지.
      ...domeFaces3(-2.1, 1, 2.9, 2.8),
      ...domeFaces3(2.2, 0.2, 2.3, 2.2),
      // 결절 점들과 앞 숨구멍 입.
      nod(-2.9, 1.9, 1.6), nod(-1.2, 2.2, 1.9), nod(2.7, 1.2, 1.7), nod(1.5, -0.4, 2.4),
      capFace(groundEllipse(mx3, my3, 0.55, 0.4), 0.5),
      /* 두 장기 사이 혈관 파이프(지적: 사각 띠 대신) — 굵기·높이·각을 달리한 캡슐
         네 가닥이 자연스럽게 잇는다. 가운데 하나는 두 마디로 살짝 처진다. */
      ...rodFaces(-0.6, 1.5, 3.6, 1.1, 0.8, 3.9, 0.5),
      ...rodFaces(-0.8, 0.6, 2.5, 0.2, 0.25, 2.2, 0.62),
      ...rodFaces(0.2, 0.25, 2.2, 1.3, 0.1, 2.7, 0.62),
      ...rodFaces(-0.4, 1.9, 1.6, 1.5, 1.25, 1.45, 0.45),
      ...rodFaces(-0.2, 0.9, 3, 1.2, 1.5, 2, 0.38),
      // 앞오른쪽 촉수 술.
