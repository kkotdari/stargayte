...
// (이동·재지적) 앞 톱니 원판 — 왼쪽 반원판의 이빨로 옮겼다.
  ...
  dship: () => {
    ...
    out.push(...tagKey(paintBase([
      ...
      bodyFace(polyPath3([[0, -2.1, 6.1], [0, -3.9, 7.5], [0, -4.4, 7.5], [0, -4.4, 5.7]])),
      sideFace(polyPath3([[0, -2.1, 6.1], [0, -3.9, 7.5], [0, -4.4, 7.5], [0, -4.4, 5.7]]), 0.18),
      // 수평 안정판 — 꼭대기에서 좌우로.
      bodyFace(polyPath3([[-1.5, -4.25, 7.3], [1.5, -4.25, 7.3], [1.15, -3.5, 7.35], [-1.15, -3.5, 7.35]])),
      topFace(polyPath3([[-1.5, -4.25, 7.3], [1.5, -4.25, 7.3], [1.15, -3.5, 7.35], [-1.15, -3.5, 7.35]]), 0.16),
