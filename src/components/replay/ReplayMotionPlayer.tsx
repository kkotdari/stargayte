...
const SHAPE_FACES: Record<string, [string, number, string?][]> = {
  ...
  arch: [
    ...
    ["M4 2 L7.4 5 L5.6 12.4 L2.2 9.4 Z", 0.2, "#fff"],
  ...
  gas: [
    ["M1.5 10 L11.5 10 L14.5 8.6 L4.5 8.6 Z", 1],
    ["M1.5 10 L11.5 10 L14.5 8.6 L4.5 8.6 Z", 0.3, "#fff"],
    ["M1.5 10 L11.5 10 L11.5 13 L1.5 13 Z", 1],
    ["M11.5 10 L14.5 8.6 L14.5 11.6 L11.5 13 Z", 1],
    ["M11.5 10 L14.5 8.6 L14.5 11.6 L11.5 13 Z", 0.35, "#000"],
  ],
