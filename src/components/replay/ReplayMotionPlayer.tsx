...
const ZERG_MOUND =
  /* 좌우 반전판(지적: 반대로 돌린 듯) — 시점이 정면-왼쪽이 아니라 정면-오른쪽 위가
     되도록 다리·뒷다리 전부 미러링했다. 조각들이 한꺼번에 뒤집혀 감김 일관성은 유지된다. */
  "M 10.6 5.7 Q 8 5.3 5.4 5.7 Q 5.1 10.4 1.8 12.6 Q 8 13.8 14.2 12.6 Q 10.9 10.4 10.6 5.7 Z M 4.6 10.3 Q 3.2 11.6 2.8 13.5 Q 2.7 14.1 3.3 14.2 L 4.3 14.4 Q 5 14.5 5.1 13.8 Q 5.5 12.6 6.1 12 Q 6.6 11.6 7 11.9 Q 7.8 12.6 8.8 13.6 Q 9.6 14.4 10.3 14.9 Q 10.8 15.3 11.3 14.9 L 11.8 14.5 Q 12.2 14 11.7 13.5 Q 11 12.7 10.1 11.8 Q 10.5 11.4 10.9 11.6 Q 12.4 11.9 13.8 12.6 Q 14.6 13 15 12.6 L 15.3 12.1 Q 15.5 11.6 14.8 11.3 Q 13.2 10.7 11.7 10.4 Q 8 11.3 4.6 10.3 Z M 13 10.1 Q 14.8 8.7 15.7 9.2 Q 16.2 9.9 15.4 10.5 Q 14.1 11.2 12.9 10.9 Z M 3.4 10 Q 2.2 8.8 1.3 9.1 Q 0.8 9.7 1.5 10.3 Q 2.4 10.9 3.3 10.6 Z";
...
const ZERG_CAP_RF = "M 5.05 13.85 A1.05 1 0 0 0 3.25 14.1 Z";
const ZERG_CAP_CF = "M 11.65 14.4 A0.85 0.8 0 0 0 10.35 14.95 Z";
const ZERG_CAP_LF = "M 15.15 12 A0.65 0.6 0 0 0 14.85 13.05 Z";
...
const SHAPE_FACES: Record<string, ShapeFace[]> = {
  ...
  lair: [
    [`${ZERG_MOUND}`
      + " M 14.8 11 Q 15.8 5.7 13 2.4 Q 11.4 0.8 10 1.6 Q 11.2 1.8 12 3.4 Q 13.2 6 12.6 10.6 Z"
      + " M 2.4 10.4 Q 1.2 5.4 3.6 2.6 Q 5 1.2 6.2 1.9 Q 5.1 2.1 4.4 3.5 Q 3.5 5.9 4.4 10 Z", 1],
    sideFace(ZERG_SHADE, 0.22),
    capFace(ZERG_CAPS_ALL),
    sideFace(ZERG_COLLAR, 0.35),
    topFace("M 12 1.2 L 10.6 1.6 L 12.2 2.6 Z M 4.5 1.6 L 5.8 1.9 L 4.4 3 Z", 0.5),
    topFace(ZERG_TOP),
  ],
  ...
  hive: [
    [`${ZERG_MOUND}`
      + " M 15 11 Q 16.2 5 13.4 1.6 Q 11.8 0.2 10.4 1 Q 11.6 1.4 12.4 3 Q 13.6 6.2 12.8 10.6 Z"
      + " M 8.6 10.2 Q 8.8 3.8 7.1 0.5 Q 5.5 3.8 5.9 10.2 Z"
      + " M 2.6 10.4 Q 1.4 4.8 3.8 1.9 Q 5.2 0.6 6.3 1.3 Q 5.2 1.5 4.6 3.1 Q 3.7 5.8 4.6 10 Z"
      + " M 13.4 14.6 Q 14.6 15.4 15.2 14.6 Q 14.4 14.4 14 13.8 Z"
      + " M 2.6 14.6 Q 1.4 15.4 0.8 14.6 Q 1.6 14.4 2 13.8 Z", 1],
    sideFace(ZERG_SHADE, 0.22),
    capFace(ZERG_CAPS_ALL),
    sideFace(ZERG_COLLAR, 0.35),
    topFace("M 11.8 0.4 L 10.4 1 L 12 2 Z M 4.7 1 L 6 1.3 L 4.6 2.4 Z M 7.8 1.2 Q 7.1 0.1 6.4 1.2 L 7.1 2.4 Z", 0.5),
    topFace(ZERG_TOP),
  ],
