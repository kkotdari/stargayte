...
//
// 순위 계산(개인은 사람단위 점수(참가+우열) → 상대 강함(SoS) / 팀은 승점 → 승수 → 경기수)은
// 전부 서버가 끝내서 내려준다 — 화면은 그 순서대로 그리고 순위 숫자만 붙인다(./rank.ts).
  ...
  return (
    <div className="scr-screen scr-rank-screen-v2">
      ...
      <div className="scr-rank-subrow">
        ...
        {!isTeam && <span className="scr-rank-hint-inline">참가 + 우열점수 → 상대 강함</span>}
      </div>
