...
export default function RankingScreenV2() {
  ...
  // 다크는 rivaly.jpg, 라이트는 tiara.png(요청). 라이트는 모바일 전용 크롭이 없어
  // 데스크톱 이미지를 그대로 쓴다.
  usePageBackground("/images/bg/rivaly.jpg", "/images/bg/rivaly_mobile.png", "/images/bg/tiara.png");
  ...
  return (
    <div className="scr-screen scr-rank-screen-v2">
      ...
      <div className="scr-v2-toolbar scr-rank-toolbar">
        ...
        {/* 상성 보기 — 개인전·종족 전체일 때만. 필터 줄이 아니라 개인전/팀전 토글 옆에 둔다(요청). */}
        {mode === "solo" && race === "all" && (
          <button
            type="button"
