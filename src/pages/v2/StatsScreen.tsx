            ...
            <span className="scr-grid-title-tail">
              ...
              <InfoTip
                ...
                text={"게임수가 적으면 일부 값은 '-'로 나와요.\n\n"
                  ...
                  + "포인트에서만 빼는 경기가 하나 있어요 — 컴퓨터나 비회원이 낀 경기예요. 0점 처리가 아니라 아예 안 친 경기로 봐요(컴퓨터는 겨룰 실력치가 없고, 비회원은 여러 사람이 한 이름을 쓸 수 있어서 그 결과로 실력을 조정할 근거가 안 돼요). 그 경기도 게임수·승률에는 그대로 들어가요.\n\n"
            ...
            <div className="scr-stat-table scr-scroll">
              ...
              <div className="scr-stat-row scr-stat-row-head">
                ...
                <SortableHead
                  ...
                  tooltip="랭크 포인트 — 이 기간·분류의 경기들로 산정한 레이팅 점수. 최소 게임수를 안 따져요(평균이 아니라 이길 때만 쌓이는 누적이라, 적게 뛰면 그냥 적게 쌓입니다). 컴퓨터·비회원이 낀 경기는 여기서만 빠져요(게임수·승률에는 들어갑니다). 괄호 안은 지금 순위와 전달 대비 변동이에요(전체 기간을 보면 견줄 전달이 없어 변동은 안 나와요). 숫자를 누르면 경기 이력(경기당 포인트 변화)이 열려요."
                />
