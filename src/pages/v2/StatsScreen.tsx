            ...
            <span className="scr-grid-title-tail">
              ...
              <InfoTip
                ...
                text={"게임수가 적으면 일부 값은 '-'로 나와요.\n\n"
                  ...
                  + "컴퓨터·비회원과 붙은 경기는 포인트가 0이에요. 빼는 게 아니라 오르내릴 수가 없어서예요 — 포인트는 상대의 실력치와 견줘 움직이는 값인데 컴퓨터·비회원에는 그 값이 없거든요. 상대 편에 회원이 한 명도 없으면 견줄 상대가 아예 없어 이겨도 져도 0이에요(팀전에서 한 자리만 그렇다면 남은 회원들끼리는 정상적으로 계산돼요). 게임수·승률에는 그대로 들어가요.\n\n"
            ...
            <div className="scr-stat-table scr-scroll">
              ...
              <div className="scr-stat-row scr-stat-row-head">
                ...
                <SortableHead
                  ...
                  tooltip="랭크 포인트 — 이 기간·분류의 경기들로 산정한 레이팅 점수. 최소 게임수를 안 따져요(평균이 아니라 이길 때만 쌓이는 누적이라, 적게 뛰면 그냥 적게 쌓입니다). 컴퓨터·비회원과 붙은 경기는 0점이에요 — 견줄 실력치가 없는 상대라 점수가 오르내릴 수가 없어요(게임수·승률에는 그대로 들어갑니다). 괄호 안은 지금 순위와 전달 대비 변동이에요(전체 기간을 보면 견줄 전달이 없어 변동은 안 나와요). 숫자를 누르면 경기 이력(경기당 포인트 변화)이 열려요."
                />
