    ...
    <div className="scr-screen scr-stats-screen-v2">
      <div className="scr-v2-toolbar">
        <div className="scr-v2-toolbar-title-row">
          ...
          {/* 칸마다 달려 있던 ⓘ 여섯 개를 여기 하나로 합쳤고, 그 뒤로 두 번 더 쳐냈다
              (요청: 라벨로 알 수 있는 건 제거 → 그래도 너무 많다). 화면에 이미 적혀 있는
              말(칸 이름, 막대 라벨, 도넛 띠)은 도움말에 다시 적어 봐야 읽을 게 하나 더
              늘 뿐이다. 남긴 네 줄은 표를 아무리 들여다봐도 알 수 없는 것들이다 —
              무엇을 빼고 셌는지, 어떤 기준으로 환산했는지, 왜 비어 있는지, 왜 0점인지. */}
          <InfoTip
            trigger="도움말"
            label="통계 표 보는 법"
            text={"· 커맨드·건물·유닛·스킬은 10분당 환산 (APM·5분 일꾼·공방 단계 제외)\n"
              + "· 건물은 파일런·서플라이, 유닛은 일꾼을 빼고 셈\n"
              + "· 건설·유닛·스킬은 리플레이 등록 경기만, APM·커맨드는 개인전 3판·팀전 10판부터\n"
