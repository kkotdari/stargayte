...
export default function StatsScreenV2() {
  // 통계 배경 = 피드 배경(요청: "피드 배경을 통계 배경으로 사용"). 다크에서만 사진이
  // 얹히고(usePageBackground/CSS 게이팅), 라이트에는 사진 없이 기본 배경.
  usePageBackground("/images/bg/feed_bg.jpg", "/images/bg/feed_bg_mobile.png");
