    ...
    <div className="scr-screen scr-stats-screen-v2">
      <div className="scr-v2-toolbar">
        <div className="scr-v2-toolbar-title-row">
          ...
          <InfoTip
            label="통계 표 보는 법"
            /* 제목 옆이라 표 헤더의 ⓘ(14)보다 한 단계 크게(요청) — 큰 글자 옆에서 12px은
               눌러야 하는 것으로 안 보인다. */
            size={18}
          ...
          <div className="scr-stat-table-clip">
            <div className="scr-stat-table scr-scroll">
              ...
              <div className="scr-stat-row scr-stat-row-head">
                ...
                {/* 랭크·포인트도 이 칸으로 들어왔다(요청: 랭킹과 기록 통합) — 이름도 지금
                    고른 기간이 아니라 '지금 그려져 있는 한 장'의 기간을 말한다. 표는 아직
                    지난 조건의 값인데 이름만 먼저 바뀌면 그것도 어긋난 그림이다. */}
                <PlainHead label={shownMonth ? "월간 기록" : "누적 기록"} />
                <PlainHead
                  label="건설"
                />
                <PlainHead
