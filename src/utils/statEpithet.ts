...
const TITLES: Title[] = [
  ...
  { ...tactic("부티 자원 퀸", ["worker-gap"]), minPlaysShare: 0.35 },
  /* 흔한 대목들의 제 문턱(시뮬레이션 실측: 격차·정찰·역전·GG·스톰은 기본 문턱으로는 거의
     전원이 걸렸다 — 자막이 그 대목을 워낙 자주 짚는다) — 기본값 대신 그 대목의 실제 빈도에
     맞는 비율을 따로 건다. 생산 격차 35%면 상위 한둘, 정찰·역전 30%·GG 25%도 같은 결이다. */
  { ...tactic("다산의 상징", ["prod-gap"]), minPlaysShare: 0.35 },
     ...
     새 재료가 필요 없고, 그런데도 "그 사람이 게임을 어떻게 다루나"를 말해 준다. */
  {
    ...
    /* 2.5 → 3.5(요청: 퀸으로 올릴 만하다) — 손 이야기 셋(유효타·APM·커맨드) 가운데 가장
       ...
       정해 두어야 나온다. */
    label: "군더더기 없는 손", weight: 3.5, min: 0.9, why: "APM 중 유효타", unit: "",
