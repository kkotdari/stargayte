...
const TITLES: Title[] = [
  ...
  { ...tactic("동맹을 지키는 포탑", ["ally-cannon"]), minPlaysShare: 0.04 },
  ...
  { ...tactic("바이오닉의 여왕", ["bionic"]), minPlaysShare: 0.24 },
  ...
  { ...tactic("뮤탈 습격대", ["muta"]), minPlaysShare: 0.03 },
  ...
  { ...tactic("오버로드 사냥꾼", ["valk-hunt"]), race: undefined, minPlaysShare: 0.03 },
  ...
  { ...tactic("부지런한 정찰 퀸", ["vision"]), minPlaysShare: 0.48 },
  { ...tactic("전장을 살피는 눈", ["vision-eye"]), minPlaysShare: 0.18 },
  ...
  { ...tactic("역전 퀸", ["revival"]), minPlaysShare: 0.36 },
  ...
  { ...tactic("방어의 여왕", ["hold-off"]), minPlaysShare: 0.08 },
  ...
  { ...tactic("지구력 대왕", ["long-run"]), minPlaysShare: 0.03 },
  ...
  { ...tactic("노엘을 외치는 여인", ["no-elim"]), minPlaysShare: 0.07 },
