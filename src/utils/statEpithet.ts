...
const TITLES: Title[] = [
  ...
  { ...spell("스톰 술사", "Psionic Storm"), minPlaysShare: 0.35 },
  ...
  { ...tactic("부티 자원 퀸", ["worker-gap"]), minPlaysShare: 0.5 },
  /* 흔한 대목들의 제 문턱(시뮬레이션 실측: 격차·정찰·역전·GG·스톰은 기본 문턱으로는 거의
     전원이 걸렸다 — 자막이 그 대목을 워낙 자주 짚는다) — 기본값 대신 그 대목의 실제 빈도에
     맞는 비율을 따로 건다. 한 번 더 올렸다(지적: 다산·군더더기·역전이 아직도 너무 잘 나온다)
     — 격차는 절반(50%), 역전은 40%, 유효타는 93%: 실측 분포의 꼭대기만 남는 값이다. */
  ...
  { ...tactic("매너 퀸", ["gg"]), minPlaysShare: 0.25 },
