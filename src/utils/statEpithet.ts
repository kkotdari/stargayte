...
const TITLES: Title[] = [
  ...
  tactic("어둠 속 포토러쉬 퀸", ["cannon-rush"], 1),
  ...
  rare("커널 개통사", ["nydus"]),
  rare("리콜 배달부", ["recall"]),
  rare("마음을 훔치는 도둑 퀸", ["mind-control"]),
     ...
     뜻이라, 그 자체가 그 사람의 취향이다. 값은 셋을 합친 수 — 많이 굴린 쪽이 임자다. */
  {
    ...
    label: "은밀한 그림자의 여왕", weight: 2.5, pool: 1, edge: 1, tier: 1,
