...
const TITLES: Title[] = [
  ...
  /* (삭제) 브루들링 저격수 · 눈을 멀게 하는 자(옵티컬 플레어) · 허깨비 부대장(할루시네이션)
     ...
     아니라 이름만 요란해진다. */
  { ...tactic("헬프 퀸", ["ally-help"]), minPlaysShare: 0.28 },
  ...
  { ...tactic("집요한 일꾼 헌터", ["harass-workers"], 1), minPlaysShare: 0.04 },
  ...
  { ...tactic("오버로드 사냥꾼", ["valk-hunt"]), race: undefined, minPlaysShare: 0.04 },
  ...
  { ...tactic("부지런한 정찰 퀸", ["vision"]), minPlaysShare: 0.42 },
  ...
  { ...rare("감염의 여왕", ["infested"]), minPlaysShare: 0.03 },
  ...
  /* 맷집왕 → 방어의 여왕(요청) — 밀려온 공세를 실제로 막아 낸 판이라, 맞고 버텼다는 쪽보다
     막아 냈다는 쪽이 그 장면에 가깝다. */
  { ...tactic("방어의 여왕", ["hold-off"]), minPlaysShare: 0.04 },
  ...
  { ...tactic("지구력 대왕", ["long-run"]), minPlaysShare: 0.04 },
