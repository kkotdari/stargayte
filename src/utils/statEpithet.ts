...
const TACTIC_WEIGHT: Record<string, number> = {
  ...
  "ally-help": 1.5, "gang-rush": 0.4,
  /* 병력 사재기·대군은 더 내린다(요청) — "많이 모았다"는 시간을 들이면 누구나 닿는 값이고,
     그 병력으로 무엇을 했는지는 말해 주지 않는다. 물량 자체는 이미 '물량퀸'이 잰다. */
  "mass-army": 0.5, "power-unit": 0.5,
};
...
const SPELL_WEIGHT: Record<string, number> = {
  ...
  스톰: 1,
  다크스웜: 1.5, 컨슘: 1.5,
  플레이그: 3, 인스네어: 3, EMP: 3, 이레디에이트: 3, 락다운: 3,
  브루들링: 5,
