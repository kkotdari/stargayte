...
const TITLES: Title[] = [
  ...
  { ...tactic("바이오닉의 여왕", ["bionic"]), minPlaysShare: 0.22 },
  ...
  { ...tactic("센터의 여주인", ["center-photon"]), minPlaysShare: 0.1 },
  ...
  { ...tactic("부지런한 정찰 퀸", ["vision"]), minPlaysShare: 0.28 },
  ...
  { ...tactic("역전 퀸", ["revival"]), minPlaysShare: 0.5 },
  ...
  { ...tactic("부티 자원 퀸", ["worker-gap"]), minPlaysShare: 0.18 },
  ...
  { ...tactic("다산의 상징", ["prod-gap"]), minPlaysShare: 0.45 },
  ...
  { ...tactic("노엘을 외치는 여인", ["no-elim"]), minPlaysShare: 0.12 },
