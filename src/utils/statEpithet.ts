...
/* 이름 짓는 규칙(요청) — 점수대가 곧 호칭의 격이다.
     3점대 이상 : 왕관 계열 — 퀸 · 여제 · 황녀 · 여신 / 왕 · 황제 · 군주 · 신 · 지배자 ·
       주인 · 마스터. '여왕'보다 '퀸'을 쓴다(요청) — 짧아서 앞말에 붙여 쓰기도 좋다.
...
const TITLES: Title[] = [
  ...
  tactic("포토러쉬퀸", ["cannon-rush"], 1),
  tactic("성큰러시퀸", ["sunken-rush"], 1),
     ...
     뜻이라, 그 자체가 그 사람의 취향이다. 값은 셋을 합친 수 — 많이 굴린 쪽이 임자다. */
  {
    ...
    label: "은신퀸", weight: 5, pool: 1, edge: 1, tier: 1,
  ...
  { label: "BEST퀸", weight: 3, why: "BEST PLAYER", unit: "회", value: (s) => (s.bests > 0 ? s.bests : null) },
