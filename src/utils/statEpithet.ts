...
const COUNT_SHARE: Record<number, number> = { 1: 0.09, 2: 0.09 };
...
/* 낮은 비율들을 한 차례 올렸다(요청) — 비례 최소 횟수(countMinFor)를 걷으면서 잣대가
   ...
   올림(40×0.01)=1). 드문 수라도 한 번은 우연이라, 마흔 판에 네 번은 나와야 하는 선
   (9%)으로 맞춘다. 백 판이면 아홉 번이다 — 두 번은 아직 우연이 섞이는 수이고, 세 번쯤
...
const TITLES: Title[] = [
  ...
  { ...tactic("메카닉 사령관", ["mech", "center-tank", "side-tank"]),
    why: "메카닉·탱크 조이기", minPlaysShare: 0.09 },
  ...
  { ...tactic("목동저그", ["moka"]), minPlaysShare: 0.09 },
  ...
  { ...tactic("센포의 여왕", ["center-photon"]), minPlaysShare: 0.11 },
  ...
  { ...tactic("몰래배럭 퀸", ["sneak-rax"]), minPlaysShare: 0.09 },
  ...
  { ...tactic("부지런한 정찰 퀸", ["vision"]), minPlaysShare: 0.32 },
  ...
  { ...rare("다크스웜 살포반", ["swarm"]), minPlaysShare: 0.09 },
  ...
  { ...tactic("역전 퀸", ["revival"]), minPlaysShare: 0.55 },
  ...
  { ...tactic("노엘을 외치는 여인", ["no-elim"]), minPlaysShare: 0.13 },
  ...
  { label: "최고의 선수", weight: 6, kind: "명예", min: 0.3, why: "판 대비 BEST 선정", unit: "",
  ...
  { label: "참여 퀸", weight: 6, kind: "명예", min: 0.7, why: "클럽 전체 판 대비 참여", unit: "",
