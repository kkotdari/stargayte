...
const TITLES: Title[] = [
  ...
  { ...tactic("동맹을 지키는 포탑", ["ally-cannon"]), minPlaysShare: 0.03 },
  ...
  { ...tactic("조이기 퀸", ["center-tank", "side-tank"]), minPlaysShare: 0.02 },
  ...
  { ...tactic("목동저그", ["moka"]), minPlaysShare: 0.04 },
  ...
  { ...rare("개통의 달인", ["nydus"]), minPlaysShare: 0.03 },
  ...
  { ...tactic("배틀크루저를 모으는 여인", ["bc"]), minPlaysShare: 0.03 },
