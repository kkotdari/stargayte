...
const TITLES: Title[] = [
  ...
  /* 커널 개통사 → 두더지녀(요청) — 땅 밑으로 굴을 뚫어 병력을 실어 나르는 그림이라
     '개통사'보다 짧고 그림이 먼저 선다. 근거 문장은 그대로 '커널'로 부른다(자막이 그 수를
     부르는 이름이다). */
  { ...rare("두더지녀", ["nydus"]), minPlaysShare: 0.01 },
  ...
  { ...tactic("매너 퀸", ["gg"]), minPlaysShare: 0.3 },
  ...
  { label: "BEST 퀸", weight: 6, kind: "명예", min: 0.42, why: "판 대비 BEST 선정", unit: "",
