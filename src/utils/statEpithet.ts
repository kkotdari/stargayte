...
const TITLES: Title[] = [
  ...
  { ...tactic("바이오닉의 여왕", ["bionic"]), minPlaysShare: 0.18 },
  ...
  { ...tactic("목동저그", ["moka"]), minPlaysShare: 0.06, vsWins: true },
  ...
  { ...rare("리콜 배달부", ["recall"]), minPlaysShare: 0.04 },
  ...
  { ...tactic("부지런한 정찰 퀸", ["vision"]), minPlaysShare: 0.22 },
  ...
  { ...rare("다크스웜 살포반", ["swarm"]), minPlaysShare: 0.04, vsWins: true },
