...
const TITLES: Title[] = [
  ...
  { ...tactic("동맹을 지키는 포탑", ["ally-cannon"]), minPlaysShare: 0.01 },
  ...
  { ...tactic("뮤탈 습격대", ["muta"]), minPlaysShare: 0.01 },
  ...
  { ...tactic("몰래배럭 퀸", ["sneak-rax"]), minPlaysShare: 0.007 },
  ...
  { ...rare("감염의 여왕", ["infested"]), minPlaysShare: 0.007 },
