...
const TEMPLATES: Record<string, Tpl> = {
  ...
  // 개편(요청) — 목동의 몸이 저글링·럴커·울트라 무엇이든, 핵심은 스웜 아래로 몰아넣는 그림이다.
  moka: act([
    "다크스웜을 얹은 목동 저그로 싸움", "병력을 모아 목동 저그를 운용함",
  ...
  arbiter: act([
    "아비터를 띄워 시공을 주무름", "스테이시스로 병력을 얼려 세움",
    "아비터와 함께 전장을 지배함", "리콜과 스테이시스로 판을 비틈",
  ]),
  vessel: act([
    "베슬을 띄워 과학전으로 판을 풀어감", "베슬 마법으로 교전을 뒤집음",
    "이레디·EMP를 뿌리며 과학전을 걺", "베슬 편대로 상대 마법 유닛을 지움",
    "과학전으로 한 수 위를 보여줌",
  ]),
  "zealot-templar": act([
    "질럿 몸에 스톰을 얹어 싸움", "질럿·하이템플러 한 벌로 진출함",
    "스톰을 지지며 질럿으로 밀어붙임", "질럿과 템플러를 함께 굴려 지상을 잡음",
    "질럿·템플러 조합으로 전장을 태움",
  ]),
  swarm: act([
