...
// 플로팅 아일랜드 전환으로 탭바 패딩이 줄며 버튼이 세로로 커졌고, 버튼보다 크게(-3)
// 그리던 알약이 세로로 길쭉해 보였다(지적: "세로로 긴 형태임 세로 줄여야대") — 반대로
// 버튼에서 3px씩 깎아 납작한 알약으로 되돌린다.
// 납작(+3)이 살짝 과했다 — 높이를 두 번에 걸쳐 조금씩 되살린다(요청: "살짝만 높이 증가"
// → 다시 "알약 높이 살짝 증가"). 버튼보다 1px씩 크게.
