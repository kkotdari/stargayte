...
// 참가한 확정 결투를 한 번에 하나씩 보여주고(요청: "결과 입력할게 여러개면 팝업도 여러개
...
// 자동으로 안 뜬다(결투 화면에서는 결과가 입력될 때까지 계속 "결과 입력" 버튼이 뜬다).
  ...
  return createPortal(
    <div className="scr-modal-overlay">
      <div className="scr-modal scr-modal-sm scr-challenge-inbox-modal">
        <div className="scr-challenge-inbox-title">지난 결투의 결과를 입력해 주세요</div>
