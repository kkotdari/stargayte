...
// 경기 유형(개인전/팀전)을 따로 고르지 않는다(요청: "결투 유형 제거하고 자동으로 판단함") —
...
interface ChallengeFormModalProps {
  ...
  // 결투 신청 "들어주기"로 열 때 — 요청 작성자를 상대로 미리 채워 넣는다.
  presetTargetIds?: string[];
  // 결투 신청 "들어주기"로 만드는 도전장이면 true — 서버가 "요청결투" 표식을 남긴다.
...
export default function ChallengeFormModal({ onClose, onCreated, presetTargetIds, fromMatchRequest, lockTarget }: ChallengeFormModalProps) {
  ...
  // 결투 신청 들어주기로 열렸으면 그 작성자를 상대로 미리 채운다.
  ...
  // 팀전으로 자동 판단한다(요청: "결투 유형 제거하고 자동으로 판단함").
    ...
    <div className="scr-modal-overlay">
      <div className="scr-modal scr-modal-sm scr-challenge-form-modal">
        ...
        <div className="scr-modal-body">
          {/* 경기 유형(개인전/팀전) 선택은 없앴다(요청: "결투 유형 제거하고 자동으로
